...
<body>
    <div class="container">
        ...
        <div class="nav-bar">
            <div class="nav-links">
                ...
                <a href="/MindDB/views/journal/show.php?id=<?= $journalId ?>">👁️ View Entry</a>
            </div>
            <div>
        ...
        <div class="main-content">
            ...
            <form id="journal-form" class="form-container" style="display: none;">
    ...
    <div id="loading-overlay" class="loading-overlay">
        <div class="loading-content">
            <p>💾 Updating your journal entry...</p>
        </div>
    </div>
    ...
    <script>
        ...
        async function loadJournalEntry() {
            try {
                ...
                populateForm(originalEntry);
                showMetadata(originalEntry);
                ...
                // Redirect to journal list after error
                setTimeout(() => {
        ...
        function populateForm(entry) {
            ...
            document.getElementById('mood_tag').value = entry.mood_tag || '';
            document.getElementById('sentiment_score').value = entry.sentiment_score || 0;
            document.getElementById('is_private').checked = entry.is_private == 1;
        ...
        function showMetadata(entry) {
            ...
            metadataContainer.innerHTML = `
                <div class="metadata-info">
                    <strong>📅 Created:</strong> ${createdAt.toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                        hour: '2-digit',
                    ...
                    ${isUpdated ? `<br><strong>📝 Last Updated:</strong> ${updatedAt.toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                        hour: '2-digit',
        ...
        async function handleSubmit(event) {
            ...
            if (!originalEntry) {
                showAlert('Error: Original entry data not loaded', 'error');
                return;
            }
            ...
            try {
                ...
                const response = await fetch(`${API_BASE}/journal_update.php`, {
                    method: 'POST',
                    headers: {
                ...
                if (result.success) {
                    ...
                    // API returned error
                    throw new Error(result.message || 'Failed to update journal entry');
                }
